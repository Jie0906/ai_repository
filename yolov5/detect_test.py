...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'C:\Users\user\Desktop\yolo_box\yolov5\runs\train\exp13\weights\best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r'C:\Users\user\Desktop\1019ans\5', help='source')  # file/folder, 0 for webcam
